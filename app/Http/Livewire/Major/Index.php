...
class Index extends Component
{
    ...
    public function mount()
    {
        ...
        $this->orderable         = (new Major())->orderable;
    }

    public function render()
    {
        $query = Major::advancedFilter([
            's'               => $this->search ?: null,
        ...
        return view('livewire.major.index', compact('majors', 'query'));
    }
    ...
    public function deleteSelected()
    {
        ...
        Major::whereIn('id', $this->selected)->delete();
