    ...
    <div class="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden" id="example-collapse-sidebar">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('form_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/employee-is*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fa-cogs">
                            </i>
                            {{ trans('cruds.form.title') }}
                        </a>
                        <ul class="ml-4 subnav hidden">
                            @can('employee_i_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/employee-is*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.employee-is.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
                                        {{ trans('cruds.employeeI.title') }}
                                    </a>
                                </li>
                            @endcan
                        </ul>
                ...
                @can('setting_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/grades*")||request()->is("admin/sites*")||request()->is("admin/religions*")||request()->is("admin/sectors*")||request()->is("admin/majors*")||request()->is("admin/departments*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fa-cogs">
                            </i>
                        ...
                        <ul class="ml-4 subnav hidden">
                            @can('grade_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/grades*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.grades.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
                            ...
                            @can('site_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/sites*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.sites.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
                            ...
                            @can('religion_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/religions*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.religions.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
                            ...
                            @can('sector_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/sectors*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.sectors.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
                            ...
                            @can('major_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/majors*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.majors.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
